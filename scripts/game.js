function game(){
 ...
 //this.letterArr=["a.png","b.png","c.png","d.png","e.png","f.png","g.png"];
 this.letterArr=["A","b","c","d","e","f","g"];
 this.letterLen=5;
 this.speed=3;
 this.spans=[];
 this.die=10;
 this.sore=0;
 //this.soreEle=document.getElementsByClassName("sore")[0].getElementsByTagName("span")[0];
 //this.dieEle=document.getElementsByClassName("die")[0].getElementsByTagName("span")[0];
 this.soreEle = document.getElementsByClassName("score")[0].getElementsByTagName("span")[0];
 this.dieEle = document.getElementsByClassName("die")[0].getElementsByTagName("span")[0];
 this.step=10;
 this.aa=1;
}
   ...
   play:function(){
    ...
    getLetter:function(num){
        ...
        for(var i=0;i<arr.length;i++){
            ...
            span.style.cssText="width:"+width+"px;height:"+height+"px;position:absolute;left:"+x+"px;top:"+y+"px;color:#fff;font-size:30px;background:url(images/a.png) no-repeat;";
